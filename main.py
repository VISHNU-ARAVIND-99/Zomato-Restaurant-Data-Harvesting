...
res_links = restaurant_link_scraping(all_loc_links=["https://www.zomato.com/chennai"])
print(len(res_links))
final = scraping(link=res_links)
json_data = json.dumps(final, indent=2, ensure_ascii=False)  # The indent parameter is optional for pretty formatting
